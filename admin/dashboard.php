...
<html>
<head>
<title>PASTRYPLAY | Admin Dashboard</title>
...
<!--four-grids here-->
		<div class="four-grids">
					...
					<div style="background-color: #854442; text-align: center; padding: 2em 0;">
							<div class="icon">
...
$cnt=$query->rowCount();
					...
					<div class="col-md-3 four-grid">
					<div style="background-color: #be9b7b; text-align: center; padding: 2em 0;">
							<div class="icon">
...
$cnt1=$query1->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div style="background:#5e4134; padding: 2em 0; text-align: center;">
							<div class="icon">
...
$cnt2=$query2->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div style="background: #9c634f; padding: 2em 0; text-align: center;">
							<div class="icon">
...
$cnt3=$query3->rowCount();
		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div style="background:#894e3f; padding: 2em 0; text-align: center;">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
							<div class="four-text">
	...
	$(document).ready(function() {
	   ...
	   jQuery('.small-graph-box .box-close').click(function() {
        ...
        fillOpacity:0.85,
			...
			lineColors:['#854442','#a2d200','#22beef'],
			xkey: 'period',
            redraw: true,
