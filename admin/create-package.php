...
<html>
<head>
<title>PASTRYPLAY | Admin Package Creation</title>
...
<div class="form-group">
 ...
 <div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Freebies</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagelocation" id="packagelocation" placeholder="Holiday freebies etc." required>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" Package Price is PHP" required>
									</div>
								</div>

<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Inclusions</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagefeatures" id="packagefeatures" placeholder="Free delivery etc." required>
									</div>
								</div>		
...
<div class="form-group">
			...
			<button type="submit" name="submit" class="btn-primary btn" style="background-color: #854442; color: white;">Create</button>
